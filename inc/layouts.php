	...
	<div id="primary-sidebar" class="primary-sidebar <?php echo $sidebar_width; ?>">
		...
		?>
			<aside class="widget widget_text">
				<h3 class="widget-title"><?php _e( 'Primary Sidebar', 'itcthemes' ); ?></h3>
				<div class="textwidget">
					<?php
						printf(
							__( 'This is the Right Sidebar Area. You can add content to this area by visiting your %1$s and adding new widgets to this area.', 'itcthemes' ),
							'<a href="' . esc_url( admin_url( 'widgets.php', 'http' ) ) . '"><b>' . __( 'Widgets Panel', 'itcthemes' ) . '</b></a>'
						);
					?>
				</div>
			</aside>
...
function get_sidebar_secondary() {
	...
	<div id="secondary-sidebar" class="secondary-sidebar <?php echo $sidebar_width; ?>">
		...
		?>
			<aside class="widget widget_text">
				<h3 class="widget-title"><?php _e( 'Secondary Sidebar', 'itcthemes' ); ?></h3>
				<div class="textwidget">
					<?php
						printf(
							__( 'This is the Left Sidebar Area. You can add content to this area by visiting your %1$s and adding new widgets to this area.', 'itcthemes' ),
							'<a href="' . esc_url( admin_url( 'widgets.php', 'http' ) ) . '"><b>' . __( 'Widgets Panel', 'itcthemes' ) . '</b></a>'
						);
					?>
				</div>
